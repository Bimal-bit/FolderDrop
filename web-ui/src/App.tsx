  ...
  return (
    ...
    >
      ...
      <div className="signal-lanes">
        <span className="signal-lane" />
        <span className="signal-lane signal-lane-mid" />
        <span className="signal-lane" />
        <span className="signal-packet signal-packet-a" />
        <span className="signal-packet signal-packet-b" />
        <span className="signal-packet signal-packet-c" />
      </div>
